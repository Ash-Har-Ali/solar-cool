...
const VisionMissionCard: React.FC<VisionMissionCardProps> = ({ title, content, bgColor }) => (
...
const DifferenceCard: React.FC<DifferenceCardProps> = ({ icon, title, content }) => (
        ...
        <div className="flex flex-col md:flex-row justify-around items-center gap-8 mb-12">
          <div className="text-center md:text-left max-w-lg">
            ...
            <p className="text-black text-base font-normal font-['Montserrat'] leading-normal mt-4 text-justify">
              “Solar cool“ is established to bring solar products to everyone’s daily life, with modern technology at an affordable cost
              and high efficiency with lower electricity bills. Now your selection of Eco-Friendly solar products could actually help the planet,
              as well as unlock a wide range of healthy advantages to a customer. We take a closer look at how the latest Solar technology is
              transforming your home and office spaces and introducing a wide range of Solar Air Conditioners, Inverter Water Geysers, Solar Refrigerators,
              Solar Deep Freezers, Ceiling Fans to the market.
            </p>
          </div>
          <div className="flex justify-center items-center">
            <div className="w-auto max-w-md bg-[#006a33]/10 rounded-tl-[142px] rounded-bl-[142px] flex justify-center items-center">
              <Image src={solarCoolLogo1} alt="Solar Cool Logo" className="object-contain p-9" />
            </div>
          </div>
        </div>
