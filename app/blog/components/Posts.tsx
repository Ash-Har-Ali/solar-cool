    ...
    <div>
      ...
      <div className="relative mb-12">
        <Image
          ...
          priority
        />
        <div className="container mx-auto px-4 sm:px-12 py-8 absolute inset-0 flex items-center  text-[#ffffff] text-center text-4xl md:text-6xl font-bold font-['Montserrat']">
          Blogs
        </div>
      </div>
