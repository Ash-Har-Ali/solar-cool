...
<div className="flex flex-col gap-6 items-center text-center">
    {[
      { icon: FaMapPin, title: "Solarcool", details: ["14/370A, Poyya, Kodungallur Rd", "Thrissur, Kerala Pin: 680733"] },
      { icon: FaEnvelope, title: "Support", details: [
          <a key="email1" href="mailto:info@solarcool.co.in" className="text-blue-600 hover:underline">info@solarcool.co.in</a>,
          <a key="email2" href="mailto:enquiry@solarcool.co.in" className="text-blue-600 hover:underline">enquiry@solarcool.co.in</a>
        ] 
      },
      { icon: FaPhoneAlt, title: "Let’s Talk", details: [
          <a key="phone1" href="tel:+918281898700" className="text-blue-600 hover:underline">+91 82818 98700</a>,
          <a key="phone2" href="tel:+917510808085" className="text-blue-600 hover:underline">+91 75108 08085</a>
        ] 
      },
  ...
  return (
    <div className="w-full bg-gray-100">
      ...
      <div className="relative w-full h-[816px]">
        <Image src={bannerImage} alt="Banner" className="w-full h-full object-cover" priority />
        ...
        <div className="absolute inset-0 flex flex-col md:flex-row">
          <div className="flex-1 flex justify-center items-center pb-6 md:pb-0 md:w-1/2">
            <h1 className="text-white text-5xl sm:text-4xl md:text-6xl font-bold pt-20 md:pt-0">Contact Us</h1>
          </div>
