...
const ServiceForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs.sendForm('service_jkgdf3g', 'template_nfkwjbs', e.target as HTMLFormElement, 'F713CPEpKwNIJ5iRc')
      .then((result) => {
        ...
        setIsSubmitted(true); // Set form submission to true after successful submission
      })
      .catch((error) => {
  ...
  return (
    <div className="max-w-lg mx-auto p-4 border rounded-lg shadow-lg">
      <h2 className="text-xl font-semibold text-center mb-6">Service Request Form</h2>
      ...
      {isSubmitted ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full py-2 bg-solarcoolgreen text-white rounded-full hover:bg-solarcoolgreen/80 transition">
            Submit Request
          </button>
        </form>
      )}
