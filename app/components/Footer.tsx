      ...
      <div className="max-w-screen-xl mx-auto px-8 md:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-start items-start md:justify-between md:items-center mb-6">
          ...
          <CTAButton
            ...
            textColor="#000"
            width="auto"
            className="border-2 mt-6 md:mt-0"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-gray-600">
              ...
              <li>
                <Link href="/products/tv" className="hover:underline">
                  Television
                </Link>
              </li>
              <li>
                <Link
                  href="/products/washingMachine"
              ...
              <li>
                <Link href="/products/cooler" className="hover:underline">
                  Air Cooler
                </Link>
              </li>
              <li>
                <Link href="/products/smartWatch" className="hover:underline">
                  Smart Watch
                </Link>
              </li>
            </ul>
