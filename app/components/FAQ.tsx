...
const faqs = [
  {
    ...
    answer:
      "We offer branding, digital marketing, SEO, web design, UI/UX, and more."
  },
  {
    question: "How can I contact you?",
    answer:
      "You can reach us via email at support@wizzyminds.com or through our contact page."
  },
  {
      ...
      <div className="space-y-4 bg-[#eeeded] p-2 rounded-2xl">
        {faqs.map((faq, index) =>
          ...
          >
            ...
            <p
              className={`text-gray-700 overflow-hidden transition-all px-6 duration-300 ${openIndex ===
              index
